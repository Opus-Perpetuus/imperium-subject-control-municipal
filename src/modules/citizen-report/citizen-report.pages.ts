        ...
        props: {
          ...
          form: {
            fields: [
              ...
              { name: "citizen_email", component: "input-text", label: "citizen email", type: "email" },
              { name: "citizen_phone", component: "input-text", label: "citizen phone", type: "tel" },
              ...
              { name: "borough", component: "input-datalist", label: "borough", optionsSource: "api://m/subject-control-municipal/boroughs?as=options&limite=1000" },
              { name: "delegado", component: "input-datalist", label: "delegado", optionsSource: "api://m/subject-rh/employee?as=options&limite=1000" },
              { name: "report_description", component: "input-textarea", label: "report description" },
              { name: "materials_used", component: "input-textarea", label: "materials used" },
              { name: "employee_taken_the_report", component: "input-datalist", label: "employee taken the report", optionsSource: "api://m/subject-rh/employee?as=options&limite=1000" },
              { name: "assinged_to", component: "input-datalist", label: "assinged to", optionsSource: "api://m/subject-rh/employee?as=options&limite=1000" },
              ...
              { name: "cuadrilla", component: "input-datalist", label: "cuadrilla", optionsSource: "api://m/subject-control-municipal/cuadrillas?as=options&limite=1000" },
              { name: "jefe_de_cuadrilla", component: "input-datalist", label: "jefe de cuadrilla", optionsSource: "api://m/subject-rh/employee?as=options&limite=1000" },
              {
                name: "priority",
              ...
              { name: "citizen_report_problem", component: "input-datalist", label: "citizen report problem", optionsSource: "api://m/subject-control-municipal/citizen-report-problem?as=options&limite=1000" },
              { name: "reporting_medium", component: "input-datalist", label: "reporting medium", optionsSource: "api://m/subject-control-municipal/citizen-report-reporting-medium?as=options&limite=1000" },
              ...
              { name: "source_instance_url", component: "input-text", label: "source instance url", type: "url" },
