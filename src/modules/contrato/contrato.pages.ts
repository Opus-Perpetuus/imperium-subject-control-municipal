        ...
        props: {
          ...
          form: {
            fields: [
              ...
              { name: "saldo", component: "input-money", label: "saldo" },
              ...
              { name: "adeudo", component: "input-money", label: "adeudo" },
              ...
              { name: "latitud", component: "input-number", label: "latitud", min: -90, max: 90 },
              { name: "longitud", component: "input-number", label: "longitud", min: -180, max: 180 },
            ],
          },
        },
      }),
