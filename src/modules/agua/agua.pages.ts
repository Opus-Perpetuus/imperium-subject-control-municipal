...
export const agua_pages: KirletPageDecl[] = [
  {
      ...
      build_feature_shell_page({
        ...
        props: {
          ...
          view: {
            ...
            pluralLabel: "parámetros",
            singularLabel: "parámetros",
          ...
          data: {
            list: `${API}/agua`,
            record: `${API}/agua/:id`,
            create: { method: "POST", action: `${API}/agua` },
            update: { method: "PATCH", action: `${API}/agua/:id` },
            delete: { method: "DELETE", action: `${API}/agua/:id` },
          },
          table: {
            columns: [
