...
WORKDIR /app
LABEL org.opencontainers.image.source="https://github.com/Opus-Perpetuus/imperium-subject-control-municipal"
LABEL org.opencontainers.image.url="https://github.com/Opus-Perpetuus/imperium-subject-control-municipal"
...
COPY src ./src
ENV PORT=3000 \
    SUBJECT_TECHNICAL_ID=subject-control-municipal \
    KIRLET_TECHNICAL_ID=subject-control-municipal \
    DATA_DIR=/data \
    SUBJECT_AUTH=on \
    KIRLET_AUTH=on
